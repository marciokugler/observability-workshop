...
DEFAULT_CONTEXT = {
    ...
    "evidence_metric_source": os.getenv("SPLUNK_EVIDENCE_METRIC_SOURCE", "support-knowledge-evidence"),
    "cache_utilization_metric": os.getenv(
        "SPLUNK_CACHE_UTILIZATION_METRIC",
        os.getenv("SUPPORT_KNOWLEDGE_CACHE_UTILIZATION_METRIC", "support_knowledge.cache.utilization"),
    ),
    "support_response_latency_metric": os.getenv(
        "SPLUNK_SUPPORT_RESPONSE_LATENCY_METRIC",
        os.getenv("SUPPORT_KNOWLEDGE_SUPPORT_RESPONSE_LATENCY_METRIC", "support_knowledge.support_response.latency_ms"),
    ),
