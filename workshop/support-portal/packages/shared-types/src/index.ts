export const BUSINESS_TRANSACTIONS = {
  customerSupportResponse: "support_response",
  caseStatusLookup: "account_status_lookup",
  knowledgeArticleSearch: "help_article_search",
...
export const ACTION_TYPES = {
  cleanServiceCache: "clean_support_knowledge_cache",
