...
- AI Support Response gets slower
...
6. In APM, inspect the AI Support Response trace path as the reliable backend proof.
...
4. approve `clean_support_knowledge_cache`

In Splunk APM, inspect:

- `remediation-orchestrator`
- `remediation-agent`
- action attributes such as `action.type=clean_support_knowledge_cache`
